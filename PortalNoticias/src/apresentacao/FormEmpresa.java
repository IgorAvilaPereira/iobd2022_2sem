...
public class FormEmpresa extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        empresa.setNome(this.inputNome.getText());
        empresa.setEndereco(this.inputEndereco.getText());
        try {
            boolean resultado = new EmpresaDAO().inserir(empresa);
                    JOptionPane.showMessageDialog(this, "Topzera, empresa adicionado com sucesso!","Portal de Notícias", JOptionPane.INFORMATION_MESSAGE);

        } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(this, "Deu xabum nas Empresas","Portal de Notícias", JOptionPane.ERROR_MESSAGE);
