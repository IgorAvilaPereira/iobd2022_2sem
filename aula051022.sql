DROP DATABASE IF EXISTS aula051022;

CREATE DATABASE aula051022;
...
/* 12) aula051022=# CREATE VIEW qtde_visualizacoes AS select                                     
    noticia_id, 
    count(*) as qtde,  
    CASE    
         WHEN COUNT(*) = 1 THEN 'lida 1x' 
